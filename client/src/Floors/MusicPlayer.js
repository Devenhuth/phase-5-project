...
function MusicPlayer() {
    ...
    return(
        <div>
            ...
            <Link to="/SoundAlarm"><button className="button1" >Try and sneak past</button></Link>
            <Link to="/WideAwake"><button className="button2" >Get a better look at the sleeping entity</button></Link>
        </div>
    )
}
